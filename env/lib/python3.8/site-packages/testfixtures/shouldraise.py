                ...
                if actual is not None:
                    if isinstance(self.exception, (ClassType, type)):
                        ...
                        if type(self.exception) is not type(actual):
                            return False
                compare(self.exception, actual, x_label="expected", y_label="raised")
            elif not actual:
    ...
    try:
        ...
        if expected_text != actual_text:
            raise AssertionError(
                diff(expected_text, actual_text, x_label="expected", y_label="actual")
            )
    else:
        raise AssertionError(
            "Expected AssertionError(%r), None raised!" % expected_text
        )
