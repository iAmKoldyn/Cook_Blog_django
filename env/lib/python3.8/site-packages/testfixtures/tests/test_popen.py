...
class Tests(TestCase):
    ...
    def test_communicate_text_mode(self):
        ...
        # check
        compare(actual, expected=("foo", "bar"))
    ...
    def test_communicate_encoding_with_errors(self):
        ...
        # usage
        process = Popen(
            "a command", stdout=PIPE, stderr=PIPE, encoding="ascii", errors="ignore"
        )
        actual = process.communicate()
        # check
        if PY2:
    ...
    def test_write_to_stdin(self):
        ...
        compare(
            ...
            expected=[
                call.Popen("a command", shell=True, stdin=PIPE),
                call.Popen("a command", shell=True, stdin=PIPE).stdin.write(
                    "some text"
                ),
            ],
        )
        compare(
            process.mock.method_calls,
            expected=[
    ...
    def test_pass_executable(self):
        ...
        compare(
            Popen.all_calls, expected=[call.Popen("a command", executable="/foo/bar")]
        )
    ...
    def test_set_command_with_list(self):
        ...
        compare(
            [call.Popen(["a", "command"], stderr=-1, stdout=-1)], actual=Popen.all_calls
        )
