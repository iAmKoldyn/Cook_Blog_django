...
class CompareTests(CompareHelper, TestCase):
    ...
    def test_simple_ignore_fields(self):
        django_compare(SampleModel(id=1), SampleModel(id=1), ignore_fields=["id"])
    ...
    def test_ignored_because_no_longer_speshul(self):
        ...
        self.check_raises(
            SampleModel(not_editable=1),
            SampleModel(not_editable=2),
            compare=django_compare,
            message=(
                "SampleModel not as expected:\n"
                "\n"
    ...
    def test_normal_compare_id_diff(self):
        ...
        self.check_raises(
            SampleModel(id=3, value=1),
            SampleModel(id=4, value=2),
            compare=django_compare,
            message=(
                "SampleModel not as expected:\n" "\n" "values differ:\n" + expected
            ),
