...
class TestReplace(TestCase):
    ...
    def test_replace_delattr(self):
        ...
        self.assertEqual(sample1.someDict, {"complex_key": [1, 2, 3], "key": "value"})
    ...
    def test_replace_delattr_not_there_not_strict(self):
        ...
        @replace("testfixtures.tests.sample1.foo", not_there, strict=False)
        def test_something(obj):
    ...
    def test_replace_delattr_cant_remove(self):
        if PY_310_PLUS:
            message = (
                "cannot set 'today' attribute of " "immutable type 'datetime.datetime'"
            )
        else:
            message = (
