...
class TestMarkersPip(base.BaseTestCase):
    ...
    scenarios = [
        ...
        ("setuptools-Bionic", {"modules": ["pip==9.0.1", "setuptools==39.0.1"]}),
        ("setuptools-Stretch", {"modules": ["pip==9.0.1", "setuptools==33.1.1"]}),
        ("setuptools-EL8", {"modules": ["pip==9.0.3", "setuptools==39.2.0"]}),
        ("setuptools-Buster", {"modules": ["pip==18.1", "setuptools==40.8.0"]}),
        ("setuptools-Focal", {"modules": ["pip==20.0.2", "setuptools==45.2.0"]}),
    ]
