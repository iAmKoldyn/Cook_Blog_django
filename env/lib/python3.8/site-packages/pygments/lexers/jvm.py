    ...
    tokens = {
        "root": [
            (
                ...
                bygroups(Text, using(this), Keyword.Declaration),
                "class",
            ),
            (r"[^\S\n]+", Text),
            (r"//.*?\n", Comment.Single),
...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "declarations": [
            ...
            (r"\b(given)\b(\s*)(%s)" % idUpper, bygroups(Keyword, Text, Name.Class)),
            (r"\b(given)\b(\s*)(%s)?" % anyId, bygroups(Keyword, Text, Name)),
        ],
        "inheritance": [
            (
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(using(this, state="modifiers"), Keyword.Declaration, Text),
                "class",
            ),
            # Variables
            (
        ...
        "modifiers": [(r"\w+", Keyword.Declaration), (r"\s+", Text), default("#pop")],
...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"[]{}|(),[]", Punctuation),
            (r"(module|import)(\s+)", bygroups(Keyword.Namespace, Text), "modname"),
            (r"\b([a-zA-Z_][\w$.]*)(::)", bygroups(Name.Namespace, Punctuation)),
            (r"\b([a-zA-Z_][\w$]*(?:\.[a-zA-Z_][\w$]*)+)\b", Name.Namespace),
            (r"(let|var)(\s+)", bygroups(Keyword.Declaration, Text), "varname"),
            (r"(struct)(\s+)", bygroups(Keyword.Declaration, Text), "structname"),
            (r"(function)(\s+)", bygroups(Keyword.Declaration, Text), "funcname"),
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            include("default"),
            (r"(%s)([ \t\r]*)(:)" % _name, bygroups(Name.Label, Text, Punctuation)),
            (_name, String.Other),
        ],
        "annotation": [
