...
class Compehension(object):
    ...
    def is_ready(self) -> bool:
        ...
        return (
            ...
            and bool(self.fors)
            and len(self.fors) == len(self.ins)
    ...
    def _check_for_in(self) -> bool:
        ...
        return all(
            for_.start[0] == in_.start[0] for for_, in_ in zip(self.fors, self.ins)
        )
    ...
    def _check_for_if(self, *, is_multiline: bool) -> bool:
        ...
        return all(if_.start[0] == self._first_for_line for if_ in self.ifs)
