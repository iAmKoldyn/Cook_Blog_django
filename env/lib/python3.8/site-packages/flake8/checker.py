...
class Manager(object):
    ...
    def make_checkers(self, paths=None):
        ...
        def should_create_file_checker(filename, argument):
            ...
            matches_filename_patterns = utils.fnmatch(filename, filename_patterns)
            is_stdin = filename == "-"
            ...
            return (explicitly_provided or matches_filename_patterns) or is_stdin
...
class FileChecker(object):
    ...
    def run_check(self, plugin, **arguments):
        ...
        try:
            ...
            raise exceptions.PluginExecutionFailed(plugin=plugin, exception=all_exc)
    ...
    def run_ast_checks(self):  # type: () -> None
        ...
        try:
            ...
            self.report("E999", row, column, "%s: %s" % (type(e).__name__, e.args[0]))
            return
