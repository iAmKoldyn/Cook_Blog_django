...
class IndonesianStemmer(BaseStemmer):
    ...
    a_2 = [
        Among("i", -1, 1, "_IndonesianStemmer__r_SUFFIX_I_OK"),
        Among("an", -1, 1, "_IndonesianStemmer__r_SUFFIX_AN_OK"),
        Among("kan", 1, 1, "_IndonesianStemmer__r_SUFFIX_KAN_OK"),
    ]
    ...
    a_3 = [
        ...
        Among("men", 2, 1),
        Among("meng", 4, 1),
        Among("meny", 4, 3, "_IndonesianStemmer__r_VOWEL"),
        Among("pem", -1, 6),
        Among("pen", -1, 2),
        Among("peng", 8, 2),
        Among("peny", 8, 4, "_IndonesianStemmer__r_VOWEL"),
        Among("ter", -1, 1),
    ]

    a_4 = [
        Among("be", -1, 3, "_IndonesianStemmer__r_KER"),
        Among("belajar", 0, 4),
        Among("ber", 0, 3),
        Among("pe", -1, 1),
        Among("pelajar", 3, 2),
